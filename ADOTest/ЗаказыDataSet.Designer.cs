...
namespace ADOTest.ЗаказыDataSetTableAdapters {
    ...
    public partial class ВидИсполненияTableAdapter : System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ADOTest.Properties.Settings.Default.ЗаказыConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT КодВида, Вид FROM ВидИсполнения";
        ...
        public virtual int FillBy(ЗаказыDataSet.ВидИсполненияDataTable dataTable) {
        ...
        public virtual ЗаказыDataSet.ВидИсполненияDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            ЗаказыDataSet.ВидИсполненияDataTable dataTable = new ЗаказыDataSet.ВидИсполненияDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
    ...
    public partial class ЗаказыTableAdapter : System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT КодЗаказа, КодРаботы, Цена, КодПредмета, КоличествоЗадач, Вариант, КодВида" +
                ", КодВуза, КодЗаказчика, НомерЗаказа, ДатаПринятия, ДатаСдачи FROM Заказы";
            this._commandCollection[1].CommandType = System.Data.CommandType.Text;
            this._commandCollection[2] = new System.Data.OleDb.OleDbCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT COUNT(*) FROM Заказы";
        ...
        [System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual ЗаказыDataSet.ЗаказыDataTable GetDataBy1() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            ЗаказыDataSet.ЗаказыDataTable dataTable = new ЗаказыDataSet.ЗаказыDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual System.Nullable<int> ScalarQueryCount() {
